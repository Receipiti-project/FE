...
const RANGES = ["이번주", "이번달", "올해"] as const;
...
export default function ReportScreen() {
  ...
  const byCat = monthlyByCategory().filter((c) => c.total > 0);
        ...
        <View style={styles.totalCard}>
          ...
          <View style={styles.totalMetaRow}>
            <View style={styles.metaItem}>
              ...
              <Text style={styles.metaValue}>16,300원</Text>
            </View>
            <View style={styles.divider} />
            <View style={styles.metaItem}>
              <Text style={styles.metaLabel}>결제 건수</Text>
              <Text style={styles.metaValue}>12건</Text>
            </View>
            <View style={styles.divider} />
            <View style={styles.metaItem}>
              <Text style={styles.metaLabel}>전월 대비</Text>
                ...
                return (
                  <View key={d.date} style={styles.barCol}>
                    ...
                    <Text
                      style={[
                        styles.barLabel,
                        isToday && { color: "#3B82F6", fontWeight: "700" },
                      ]}
                    >
                      {d.label}
                    </Text>
                  ...
                  <View style={styles.todHead}>
                    <View
                      style={[
                        styles.todIcon,
                        {
                          backgroundColor: isPeak ? "#3B82F6" : "#EFF6FF",
                        },
                      ]}
                    >
                      <Ionicons
                    ...
                    <View
                      style={[
                        styles.todBarFill,
                        {
                          ...
                          backgroundColor: isPeak ? "#3B82F6" : "#BFDBFE",
                        },
                      ]}
                    />
                  </View>
                ...
                return (
                  <View key={d.label} style={styles.barCol}>
                    ...
                    <Text
                      style={[
                        styles.dowLabel,
                        d.isWeekend && { color: "#A855F7", fontWeight: "700" },
                      ]}
                    >
                      {d.label}
                    </Text>
          ...
          <View style={{ gap: 10 }}>
            {AI_INSIGHTS.map((ins) => (
              <View
                ...
                style={[
                  styles.insightCard,
                  { borderLeftColor: ins.accent },
                ]}
              >
                <View
                  style={[
                    styles.insightIcon,
                    { backgroundColor: `${ins.accent}1A` },
                  ]}
                >
          ...
          <View style={styles.classifyCard}>
            <View style={styles.classifyRow}>
              <View style={[styles.classifyStat, { borderRightWidth: 1 }]}>
                <Text style={styles.classifyValue}>
                  {CATEGORIZATION_STATS.autoMatched}
                </Text>
                <Text style={styles.classifyLabel}>자동 매칭</Text>
              </View>
              <View style={[styles.classifyStat, { borderRightWidth: 1 }]}>
                <Text style={[styles.classifyValue, { color: "#7C3AED" }]}>
                  {CATEGORIZATION_STATS.userCorrected}
                </Text>
                <Text style={styles.classifyLabel}>내가 수정</Text>
              </View>
              <View style={styles.classifyStat}>
                <Text style={[styles.classifyValue, { color: "#F59E0B" }]}>
                  {CATEGORIZATION_STATS.pending}
                </Text>
            ...
            <View style={styles.classifyAccBox}>
              <View style={styles.classifyAccHead}>
                ...
                <Text style={styles.classifyAccVal}>
                  {Math.round(CATEGORIZATION_STATS.accuracy * 100)}%
                </Text>
              </View>
              ...
              <Text style={styles.classifyHint}>
                내 수정 이력이 많을수록 더 정확해져요. 매장명·금액 토큰을 학습에
                반영합니다.
              </Text>
            </View>
          </View>

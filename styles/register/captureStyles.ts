...
export const styles = StyleSheet.create({
  ...
  locationText: { flex: 1, color: "#374151", fontSize: 12, lineHeight: 17 },
  locationEmptyText: { flex: 1, color: "#9CA3AF", fontSize: 12 },
  locationAction: { color: "#3B82F6", fontSize: 12, fontWeight: "700" },
  paymentDateRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  paymentDateText: { flex: 1, color: "#111827", fontSize: 14, fontWeight: "600" },
  dateTimeWarning: { color: "#D97706", fontSize: 10, lineHeight: 15, marginTop: 6 },

...
export const styles = StyleSheet.create({
  ...
  dragHint: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: -2, marginBottom: 10, paddingHorizontal: 2 },
  dragHintText: { flex: 1, color: "#6B7280", fontSize: 12, lineHeight: 17 },
  ...
  dragHandle: { width: 32, height: 44, alignItems: "center", justifyContent: "center", marginRight: -6 },
